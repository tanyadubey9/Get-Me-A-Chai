  ...
  return (
    <>
      <div className="flex flex-col justify-center items-center min-h-[70vh] text-white gap-8">
        <h1 className="md:text-5xl text-3xl font-bold flex items-center justify-center gap-2 text-center">Get Me A Chai <span><img src="/tea.gif" alt="tea" className="md:w-20 w-14" /></span></h1>
      ...
      <div className="my-10 text-white p-5">
        ...
        <div className="flex justify-around md:m-10 gap-3">
          <div className="flex flex-col justify-center items-center gap-3">
            <div>
              <img className="bg-gray-300 rounded-full p-3 md:w-28 w-16" src="/woman.gif" alt="woman" />
            </div>
          ...
          <div className="flex flex-col justify-center items-center gap-3">
            <div>
              <img className="bg-gray-300 rounded-full p-3 md:w-28 w-16" src="/coin.gif" alt="coin" />
            </div>
            <h4 className="font-bold text-center"> Fund Yourself</h4>
            <p className="text-center">your fans are available to help you</p>
          </div>
          <div className="flex flex-col justify-center items-center gap-3">
            <div>
              <img className="bg-gray-300 rounded-full p-3 md:w-28 w-16" src="/fans.gif" alt="fans" />
            </div>
